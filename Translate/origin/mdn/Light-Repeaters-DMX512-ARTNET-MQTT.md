---
title: MIDI-MT - Оборудование DMX512/ArtNet
...
Устройства «Репитер» и «Конечная точка» используют `HTTP` сервер, для получения конфигурации сети **DMX512** в `json` формате. 
